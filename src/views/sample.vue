        ...
        <v-row>
          ...
          <v-container class="background-container">
           ...
           <!--  <v-img class="id1"  :src="selectedImage"  contain></v-img>
            ...
            <qrcode-vue class="qr1" v-if="detailsname.Controlno" :value="detailsname.Controlno" :style="{ width: '180px', height: '175px' }"   />
        ...
        <v-col>
          <v-container class="background-container ml-4">
           <!--  <div class="association2">{{ detailsname.association }}</div>
            ...
            <qrcode-vue class="qr2" v-if="detailsname.Controlno" :value="detailsname.Controlno" :style="{ width: '180px', height: '175px' }" />
...
.background-container {
  background-image: url("@/assets/plain_background.png");
  background-size: cover;
  background-repeat: no-repeat;
  height: 4000%;
}
