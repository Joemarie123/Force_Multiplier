...
export default {
    ...
    created() {
            ...
            this.selectedImage = `http://10.0.1.23:82/forcemultiplier/img/${ localStorage.getItem('Controlno')}1.jpg`
            this.selectedImage_license = `http://10.0.1.23:82/forcemultiplier/img/${ localStorage.getItem('Controlno')}2.jpg`
...
@media print {
    ...
    .association1 {
        ...
        font-weight: 900;
         /* -webkit-text-fill-color: rgb(42, 201, 95); */
        /* Will override color (regardless of order) */
        /* -webkit-text-stroke-width: .5px;
        -webkit-text-stroke-color: rgb(250, 247, 247);
       font-family:  Arial; */
    }
    ...
    #print-area {
        size: 100%;
        margin: 0.22 0.31 0.31 0.31 !important;
        /* margin: auto; */
    }
}</style>